...
export const DECK_SLIDES: Slide[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { label: "结果", value: "诊断渠道转化约 1.3×（+30%），搜索整体转化净增 +0.5pp" },
    ],
  ...
  },
  {
    ...
    items: [
      {
        label: "转化提升",
        text: "诊断渠道的意向→交易转化达到原路径 **约 1.3×（+30%）**；把价格敏感用户导入这条更高转化的渠道，搜索整体转化 **净增 +0.5pp**，规模化下预计每日新增约 **2k** 订单。",
      },
      {
        label: "信任改善（预测）",
        text: "预计价格争议相关投诉下降 **50%**，说明用户预期与实际履约更一致。",
      },
      {
        label: "决策效率",
